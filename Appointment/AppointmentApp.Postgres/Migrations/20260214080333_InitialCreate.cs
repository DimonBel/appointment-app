        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredFields = table.Column<Dictionary<string, string>>(type: "jsonb", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DomainConfigurations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataFields = table.Column<Dictionary<string, string>>(type: "jsonb", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreOrderData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PreOrderData_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProfessionalId = table.Column<Guid>(type: "uuid", nullable: false),
                    DomainConfigurationId = table.Column<Guid>(type: "uuid", nullable: true),
                    DomainType = table.Column<int>(type: "integer", nullable: false),
                    ...
                    PreOrderDataId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_ProfessionalId",
                        column: x => x.ProfessionalId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_ProfessionalId1",
                        column: x => x.ProfessionalId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_AvailabilitySlots_PreOrderDataId",
                        column: x => x.PreOrderDataId,
                        principalTable: "AvailabilitySlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_DomainConfigurations_DomainConfigurationId",
                        column: x => x.DomainConfigurationId,
                        principalTable: "DomainConfigurations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Orders_PreOrderData_PreOrderDataId",
                        column: x => x.PreOrderDataId,
                        principalTable: "PreOrderData",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderHistory_AspNetUsers_ChangedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilitySlots_SlotDate",
                table: "AvailabilitySlots",
                column: "SlotDate");

            migrationBuilder.CreateIndex(
                name: "IX_AvailabilitySlots_SlotDate_StartTime_EndTime",
                table: "AvailabilitySlots",
                columns: new[] { "SlotDate", "StartTime", "EndTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_DomainConfigurationId",
                table: "Orders",
                column: "DomainConfigurationId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_PreOrderDataId",
                table: "Orders",
                column: "PreOrderDataId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Orders_ProfessionalId",
                table: "Orders",
                column: "ProfessionalId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_ProfessionalId1",
                table: "Orders",
                column: "ProfessionalId1");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_ScheduledDateTime",
                table: "Orders",
