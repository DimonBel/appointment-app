        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ContextData = table.Column<Dictionary<string, object>>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalOrderId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingDrafts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookingDrafts_Conversations_ConversationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuggestedOptions = table.Column<List<string>>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingDrafts_ConversationId",
                table: "BookingDrafts",
                column: "ConversationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BookingDrafts_UserId",
                table: "BookingDrafts",
                column: "UserId");
